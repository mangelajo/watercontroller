...
def test_alarm_card_round_trips_through_ui(page, host_url: str):
    page.goto(host_url)
    page.click('button[data-tab="sprinklers"]')

    # Fill in new alarm values.
    page.locator("#alarm-enabled").check()
    page.locator("#alarm-threshold").fill("150")
    page.locator("#alarm-duration").fill("45")
